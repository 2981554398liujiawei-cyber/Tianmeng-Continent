...
export const SKILLS: Record<string, SkillDefinition> = {
  ...
  // ---- TM-P2-013 §9/§10：黑石塔深层敌人技能（复用现有 cooldown/once/AI 机制；不新增状态引擎） ----
  enemy_sentinel_crushing_maul: {
    id: 'enemy_sentinel_crushing_maul',
    name: '守卫重锤',
    description: '黑石守卫抡起石锤，缓慢却沉重地砸下。',
    mpCost: 0,
    tags: ['physical', 'force'],
    combat: { damageFormula: '敌方攻击力 + 3（冷却 2 回合）', damageResolver: { type: 'attack_power', bonus: 3 }, cooldownTurns: 2 },
  },
  enemy_mist_drain: {
    id: 'enemy_mist_drain',
    name: '黑雾侵蚀',
    description: '黑雾残影化作细流，绕过甲缝渗入呼吸。',
    mpCost: 0,
    tags: ['magic'],
    combat: { damageFormula: '敌方敏捷 + 4（冷却 1 回合）', damageResolver: { type: 'agility_power', bonus: 4 }, cooldownTurns: 1 },
  },
  enemy_warden_black_smash: {
    id: 'enemy_warden_black_smash',
    name: '黑石重击',
    description: '黑石守门者挥动整条石臂，把黑石的力量砸进对方防线。',
    mpCost: 0,
    tags: ['physical', 'force'],
    combat: { damageFormula: '敌方攻击力 + 4（冷却 2 回合）', damageResolver: { type: 'attack_power', bonus: 4 }, cooldownTurns: 2 },
  },
  enemy_warden_shock_armor: {
    id: 'enemy_warden_shock_armor',
    name: '震荡护甲',
    description: '守门者周身的黑石甲片骤然震颤，震开近身的敌人。',
    mpCost: 0,
    tags: ['physical'],
    combat: { damageFormula: '敌方攻击力 + 2（冷却 1 回合）', damageResolver: { type: 'attack_power', bonus: 2 }, cooldownTurns: 1 },
  },
  enemy_warden_gate_sweep: {
    id: 'enemy_warden_gate_sweep',
    name: '封门横扫',
    description: '守门者横扫巨臂，把一切试图靠近封印之门的存在推开。',
    mpCost: 0,
    tags: ['physical', 'force'],
    combat: { damageFormula: '敌方攻击力 + 6（冷却 3 回合）', damageResolver: { type: 'attack_power', bonus: 6 }, cooldownTurns: 3 },
  },
