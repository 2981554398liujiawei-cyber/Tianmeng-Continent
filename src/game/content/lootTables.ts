...
export const DROP_TABLES: Record<string, DropTable> = {
  ...
  blackstone_sentinel: { id: 'blackstone_sentinel', guaranteed: [{ itemId: 'wolf_meat', quantity: [1, 1] }] },
  black_mist_wraith: { id: 'black_mist_wraith', guaranteed: [{ itemId: 'spirit_shard', quantity: [1, 1] }] },
  blackstone_warden: { id: 'blackstone_warden', guaranteed: [{ itemId: 'wolf_meat', quantity: [1, 2] }] },
